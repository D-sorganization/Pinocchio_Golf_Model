...
class PinkSolver:
    ...
    def __init__(self, robot_model: pin.Model, robot_data: pin.Data, robot_visual: pin.GeometryModel, robot_collision: pin.GeometryModel):
    ...
    def solve(
        ...
        q_next = pin.integrate(self.model, q_init, velocity * dt)
